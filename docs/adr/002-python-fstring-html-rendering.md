...
The project's design philosophy explicitly rejects template engines. This constraint exists alongside parallel rejections of Node.js build tooling, CSS preprocessors, and JavaScript frameworks. The project values minimal dependencies, native tooling, and keeping the entire system legible as plain Python.
